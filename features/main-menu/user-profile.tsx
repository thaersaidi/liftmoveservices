...
import { CircleUserRound, LogOut, Calculator, Archive } from "lucide-react";
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent side="right" className="w-56" align="end">
        ...
        >
          <Archive {...menuIconProps} size={18} ></Archive>
          <span>Updates</span>
        </DropdownMenuItem>      
        <DropdownMenuSeparator />
        <DropdownMenuItem
          className="flex gap-2"
          onClick={() => RedirectToPage("calculator")}
        >
          <Calculator {...menuIconProps} size={18} ></Calculator>
