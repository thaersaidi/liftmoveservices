...
export const AddExtension: FC<Props> = (props) => {
  ...
  return (
    ...
    >
      <SheetContent className="w-full min-w-full sm:min-w-[32em] md:min-w-[680px] flex flex-col">
      <SheetHeader>
          <SheetTitle>Agent (Extension)</SheetTitle>
        </SheetHeader>
            ...
            <div className="pb-6 px-6 flex gap-8 flex-col">
              ...
              <div className="grid gap-2">
                ...
                <Textarea
                  ...
                  name="executionSteps"
                  placeholder="Describe specialties and the execution steps"
                />
              </div>
              <EndpointHeader />
              <AddFunction />
