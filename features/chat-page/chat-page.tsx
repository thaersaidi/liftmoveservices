...
export const ChatPage: FC<ChatPageProps> = (props) => {
  ...
  return (
    <main className="flex flex-1 flex-col relative w-full h-full">
      <ChatHeader
        chatThread={props.chatThread}
        chatDocuments={props.chatDocuments}
        extensions={props.extensions}
      />
      <ChatMessageContainer ref={current} className="flex-1 overflow-auto">
        <ChatMessageContentArea className="flex flex-col gap-4 p-4">
